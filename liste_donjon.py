...
donjons_data = {
    ...
    50: [
        ("Le Papaturage Royal", "https://stratfu.fr/50/papaturage_royal/", 6),
        ("La Montagne Adezieu", "https://stratfu.fr/50/montagne_adezieu/", 6),
        ("Donjon Equipage Du Poulpe", "https://stratfu.fr/50/poulpe/", 6),
        ("Les Champs Pourchan", "https://stratfu.fr/50/champ_pourchan/", 6),
        ("Donjon Morts-Brûlés", "https://stratfu.fr/50/mort_brule/", 6),
        ("La Tour Minérale 50", "https://stratfu.fr/50/tour_mineral50/", 3),
        ("Tournée 50", "https://stratfu.fr", 6),
    ],
    65: [
